...
def create_new_world():
    ...
    def main():
        ...
        fps = 99999999999999999999999999999999999999999999999999999999999999999999999999999999999999
        font = pygame.font.SysFont('consolas',20)
        pygame.display.set_caption('Minecraft: Python Edition')
        clock.tick(fps)
        pygame.display.set_mode(display, DOUBLEBUF|OPENGL)
        pygame.display.set_icon(r"F:\minecraftFiles\pygame_img\gameWindowIcon.png")
