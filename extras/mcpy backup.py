...
button_sound = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles\audio\button\buttonclick.wav")
window = Tk()
w = 1366
h = 768
...
def create_new_world():
    ...
    #Fire up the source code of most of Minecraft!
    
    pygame.init()
    
    def main():
        gameres = (500,500)
        gameIcon = pygame.image.load(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles\pygame_img\gameWindowIcon.png")
        pygame.display.set_icon(gameIcon)
        clock = pygame.time.Clock()
        font = pygame.font.SysFont('consolas',20)
        fps = 99999999999999999999999999999999999999999999999999999999999999999999999999999999
        display = pygame.display.set_mode(gameres, pygame.OPENGL|DOUBLEBUF)
        pygame.display.set_caption('Minecraft: Python Edition   |   FPS: ' + str(int(clock.get_fps())))
        clock.tick(fps)
...
def tkinter_background_sound():
    picker = random.choice(["m1", "m2", "m3", "m4", "m5", "m6", "m7", "m8", "m9", "m10", "m11"])
    if picker == "m1":
        source1 = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/audio/tkinter_background/m1.wav")
        source1.play()
    
    if picker == "m2":
        source2 = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/audio/tkinter_background/m2.wav")
        source2.play()

    if picker == "m3":
        source3 = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/audio/tkinter_background/m3.wav")
        source3.play()
    
    if picker == "m4":
        source4 = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/audio/tkinter_background/m4.wav")
        source4.play()
    
    if picker == "m5":
        source5 = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/audio/tkinter_background/m5.wav")
        source5.play()
    
    if picker == "m6":
        source6 = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/audio/tkinter_background/m6.wav")
        source6.play()
    
    if picker == "m7":
        source7 = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/audio/tkinter_background/m7.wav")
        source7.play()
    
    if picker == "m8":
        source8 = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/audio/tkinter_background/m8.wav")
        source8.play()
    
    if picker == "m9":
        source9 = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/audio/tkinter_background/m9.wav")
        source9.play()
    
    if picker == "m10":
        source10 = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/audio/tkinter_background/m10.wav")
        source10.play()
    
    if picker == "m11":
        source11 = oalOpen(r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/audio/tkinter_background/m11.wav")
        source11.play()
...
background_image_home = PhotoImage(file = r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/tkinter_img/background_edited_png.png")

background_image_home_place = Label(window, image = background_image_home, bg = 'white')

background_image_home_place.place(x = 0, y = 0)

logo = PhotoImage(file = r"C:\Users\ys080\Desktop\mcpy\minecraftFiles/tkinter_img/title.png")
...
create_new_world_button = Button(window, bd = 4, height = 2, width = 22, font = ('Minecraft', 20), text = 'Create New World', activebackground = 'green',
                                 command = world_generation_options)
